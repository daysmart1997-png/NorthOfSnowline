...
const SITES={
 "canteen":{"asset":"canteen","path":"res://assets/settlement/canteen.glb","at":Vector3(10,0,78),"half_width":3.2,"half_depth":3.1,"layer":1024,"bed":false,"heat":false,"loss":1.6,"title":"废弃伙房","description":"炉灶已拆走，窗缝漏雪。后墙架上也许还留着干粮；取完回炭工木屋生火。","obstacles":[[Vector3(0,.9,-2.65),Vector3(4.4,1.8,.65)],[Vector3(-2.4,.75,-.8),Vector3(.85,1.5,1.65)],[Vector3(-1.6,.44,1),Vector3(2.2,.88,1)]]},
 "woodshed":{"asset":"woodshed","path":"res://assets/settlement/woodshed.glb","at":Vector3(-23,0,87),"half_width":2.8,"half_depth":2.4,"layer":2048,"bed":false,"heat":false,"loss":2.4,"title":"旧柴棚","description":"板缝透风，外侧柴已受潮。后架油布下留着有限干柴；睡前给炉子留一份。","obstacles":[[Vector3(-2.05,.8,-.1),Vector3(1.05,1.6,3.8)],[Vector3(2.05,.8,-.1),Vector3(1.05,1.6,3.8)],[Vector3(0,.35,-1.65),Vector3(2.3,.7,.9)]]},
 "bunkhouse":{"asset":"bunkhouse","path":"res://assets/settlement/bunkhouse.glb","at":Vector3(12,0,59),"half_width":4.0,"half_depth":2.8,"layer":4096,"bed":false,"heat":false,"loss":1.8,"title":"破损工人宿舍","description":"床毯已经湿透，无法休息。遗留衣物可拆作布料，换班记录还压在桌上。","obstacles":[[Vector3(-2.85,.35,-.6),Vector3(1.45,.7,2.5)],[Vector3(2.85,.35,-.6),Vector3(1.45,.7,2.5)],[Vector3(-1.5,.32,-1.6),Vector3(.17,.64,1.6)],[Vector3(0,.43,-2.2),Vector3(2.2,.86,.7)]]},
...
const SUPPLIES={
 "canteen_pantry":{"site":"canteen","at":Vector3(0,1.02,-2.4),"title":"后墙架上的应急干粮","contents":{"food":2,"water":1}},
 "shed_fuel":{"site":"woodshed","at":Vector3(0,.72,-1.65),"title":"油布下的干柴","contents":{"wood":4}},
 "bunk_effects":{"site":"bunkhouse","at":Vector3(0,.88,-2.2),"title":"工人的遗留衣物","contents":{"cloth":2,"bandage":1,"water":1}},
